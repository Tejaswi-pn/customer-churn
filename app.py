...
def load_artifacts():
    ...
    # Load Preprocessor
    preprocessor = pickle.load(open("preprocessor (4).pkl", "rb"))

    # Load Model
    if os.path.exists("churn_model (1).keras"):
        model = tf.keras.models.load_model("churn_model (1).keras")
        ...
        raise FileNotFoundError(
            ...
            "Expected: churn_model (1).keras or model.keras"
        )
